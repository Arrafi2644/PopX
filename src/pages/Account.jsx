                ...
                <div className=' '>
                    <div className='flex gap-4 p-6'>
                        <div className='w-20 h-20 relative'>
                            <img className='w-full h-full object-cover' src="https://i.ibb.co/pBVXr0gk/user2.png" alt="" />
                            <div className=' inline-block rounded-full bg-purple-600 p-1 text-white absolute -right-[5px] top-[50px]'>
                                <IoCamera />
                            </div>
                        </div>
                        <div>
                            <h3 className='font-bold'>Merry</h3>
                            <p className='font-medium'>merry@gmail.com</p>
                        </div>
